...
public protocol MiddlewareReaderProtocol: Sendable {
    ...
    var inject: @MainActor (Dependencies) -> MiddlewareType { get }
    ...
    ///                     When inject is called, your MiddlewareReader materializes into a Middleware.
    init(inject: @MainActor @escaping (Dependencies) -> MiddlewareType)
}
