    ...
    @MainActor func testStoreFullWorkflowIntegration() {
        ...
        fooMiddleware.handleActionFromStateClosure = { action, _, _ in
            ...
            return IO { output in
                ...
                output.dispatch(.bar(.bravo), from: .here())
        ...
        XCTAssertEqual(subjectMock.currentValue.name, "_foo_bravo_charlie_alpha_foo_bravo_delta_echo_echo")
    }
}
